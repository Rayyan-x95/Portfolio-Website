        ...
        <div className="container mx-auto max-w-[1400px] flex items-center justify-between pointer-events-auto relative">
          ...
          <div className="flex-1 flex items-center">
            <motion.div 
              ...
              className="flex items-center gap-6 mix-blend-difference origin-left relative z-20"
            >
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-[8px] font-mono uppercase tracking-[0.4em] text-white/40 leading-none mb-1.5">// Precision Industrial</span>
                  <span className="text-[8px] font-mono uppercase tracking-[0.4em] text-accent-primary leading-none font-black">System v4.0.1</span>
                </div>
              </motion.div>
            </motion.div>
          </div>
          ...
          <div className="hidden md:flex flex-none justify-center">
            <motion.div 
              ...
              className="flex items-center gap-1 border border-white/5 p-1 rounded-full mix-blend-difference transition-all duration-500 hover:shadow-[0_0_40px_rgba(0,229,255,0.05)] hover:border-white/20"
            ...
            >
              <nav className="flex items-center gap-1">
                {mainLinks.map((link) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`relative px-4 lg:px-6 py-2.5 rounded-full text-[9px] lg:text-[10px] font-mono uppercase tracking-[0.3em] transition-all duration-500 ${
                ...
                <div className="relative" ref={dropdownRef}>
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-2.5 rounded-full text-[9px] font-mono uppercase tracking-[0.3em] transition-all duration-500 relative ${
                  ...
                  <AnimatePresence>
                    {isMoreOpen && (
                      <motion.div
                        ...
                        className="absolute top-[60px] left-1/2 -translate-x-1/2 w-[580px] bg-[#050505]/95 backdrop-blur-3xl border border-white/5 rounded-[2rem] p-4 shadow-2xl flex gap-3 z-[110] pointer-events-auto"
                      >
                        <Link 
                          href="/labs"
                          onClick={() => setIsMoreOpen(false)}
                          className="relative flex-1 bg-white/[0.02] border border-white/5 rounded-3xl p-8 overflow-hidden group hover:bg-white/[0.04] transition-all duration-500"
                        >
                          ...
                          <div className="mt-auto relative z-10">
                            <h3 className="text-xl font-bold text-white mb-2 font-heading tracking-tighter uppercase italic">Labs</h3>
                            <p className="text-[10px] font-mono text-white/40 uppercase tracking-widest leading-relaxed max-w-[180px]">
                        ...
                        <div className="w-[240px] flex flex-col gap-2">
                          {moreLinks.slice(1).map((item) => (
                            ...
                            >
                              <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center group-hover:bg-accent-primary group-hover:scale-110 transition-all">
                              ...
                              <div className="flex flex-col">
                                ...
                                <span className="text-[8px] font-mono text-white/20 uppercase tracking-widest mt-1">{item.sub}</span>
                              </div>
                            </Link>
                          ))}
                        </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <Link 
                  href="/contact"
                  data-cursor="contact"
                  className="px-6 py-2.5 rounded-full border border-white/5 bg-white/2 text-[9px] font-mono font-bold text-white uppercase tracking-[0.3em] hover:bg-white hover:text-black transition-all"
                >
                  Book a Call
                </Link>
              </div>
          ...
          >
            <div className="absolute top-8 right-8">
              <button 
                ...
                className="w-12 h-12 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-white/40 hover:text-white transition-all"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
